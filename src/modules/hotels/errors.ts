...
export const HotelErrorCodes = {
  ...
  HOTEL_NOT_APPROVED: 'HOTEL_NOT_APPROVED',
  BRANCH_ALREADY_DEACTIVATED: 'BRANCH_ALREADY_DEACTIVATED',
  BRANCH_ALREADY_ACTIVE: 'BRANCH_ALREADY_ACTIVE',
} as const;
...
export const HotelErrorMap: Record<string, HttpStatus> = {
  ...
  [HotelErrorCodes.HOTEL_NOT_APPROVED]: HttpStatus.FORBIDDEN,
  [HotelErrorCodes.BRANCH_ALREADY_DEACTIVATED]: HttpStatus.CONFLICT,
  [HotelErrorCodes.BRANCH_ALREADY_ACTIVE]: HttpStatus.CONFLICT,
};
